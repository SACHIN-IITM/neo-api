...
--
-- Table structure for table `backtest_threemindata`
--

DROP TABLE IF EXISTS `backtest_threemindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `backtest_threemindata` (
...
--
-- Dumping data for table `backtest_threemindata`
--

LOCK TABLES `backtest_threemindata` WRITE;
/*!40000 ALTER TABLE `backtest_threemindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `backtest_threemindata` ENABLE KEYS */;
UNLOCK TABLES;
