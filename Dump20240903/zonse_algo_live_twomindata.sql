...
--
-- Table structure for table `live_twomindata`
--

DROP TABLE IF EXISTS `live_twomindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_twomindata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39670 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_twomindata`
--

LOCK TABLES `live_twomindata` WRITE;
/*!40000 ALTER TABLE `live_twomindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_twomindata` ENABLE KEYS */;
UNLOCK TABLES;
