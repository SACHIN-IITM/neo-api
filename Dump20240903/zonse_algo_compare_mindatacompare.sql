...
--
-- Table structure for table `compare_mindatacompare`
--

DROP TABLE IF EXISTS `compare_mindatacompare`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `compare_mindatacompare` (
...
--
-- Dumping data for table `compare_mindatacompare`
--

LOCK TABLES `compare_mindatacompare` WRITE;
/*!40000 ALTER TABLE `compare_mindatacompare` DISABLE KEYS */;
/*!40000 ALTER TABLE `compare_mindatacompare` ENABLE KEYS */;
UNLOCK TABLES;
