...
--
-- Table structure for table `live_mindata`
--

DROP TABLE IF EXISTS `live_mindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_mindata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=79284 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_mindata`
--

LOCK TABLES `live_mindata` WRITE;
/*!40000 ALTER TABLE `live_mindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_mindata` ENABLE KEYS */;
UNLOCK TABLES;
