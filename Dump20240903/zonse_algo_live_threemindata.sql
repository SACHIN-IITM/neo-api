...
--
-- Table structure for table `live_threemindata`
--

DROP TABLE IF EXISTS `live_threemindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_threemindata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26593 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_threemindata`
--

LOCK TABLES `live_threemindata` WRITE;
/*!40000 ALTER TABLE `live_threemindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_threemindata` ENABLE KEYS */;
UNLOCK TABLES;
