...
--
-- Table structure for table `compare_threemindatacompare`
--

DROP TABLE IF EXISTS `compare_threemindatacompare`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `compare_threemindatacompare` (
...
--
-- Dumping data for table `compare_threemindatacompare`
--

LOCK TABLES `compare_threemindatacompare` WRITE;
/*!40000 ALTER TABLE `compare_threemindatacompare` DISABLE KEYS */;
/*!40000 ALTER TABLE `compare_threemindatacompare` ENABLE KEYS */;
UNLOCK TABLES;
