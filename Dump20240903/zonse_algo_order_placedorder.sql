...
--
-- Table structure for table `order_placedorder`
--

DROP TABLE IF EXISTS `order_placedorder`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_placedorder` (
...
--
-- Dumping data for table `order_placedorder`
--

LOCK TABLES `order_placedorder` WRITE;
/*!40000 ALTER TABLE `order_placedorder` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_placedorder` ENABLE KEYS */;
UNLOCK TABLES;
