...
--
-- Table structure for table `live_fourmindata`
--

DROP TABLE IF EXISTS `live_fourmindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_fourmindata` (
...
--
-- Dumping data for table `live_fourmindata`
--

LOCK TABLES `live_fourmindata` WRITE;
/*!40000 ALTER TABLE `live_fourmindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_fourmindata` ENABLE KEYS */;
UNLOCK TABLES;
