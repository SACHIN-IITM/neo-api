...
--
-- Table structure for table `live_fivemindata`
--

DROP TABLE IF EXISTS `live_fivemindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_fivemindata` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16104 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_fivemindata`
--

LOCK TABLES `live_fivemindata` WRITE;
/*!40000 ALTER TABLE `live_fivemindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_fivemindata` ENABLE KEYS */;
UNLOCK TABLES;
