...
--
-- Table structure for table `live_trigger_data`
--

DROP TABLE IF EXISTS `live_trigger_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `live_trigger_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26716 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `live_trigger_data`
--

LOCK TABLES `live_trigger_data` WRITE;
/*!40000 ALTER TABLE `live_trigger_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `live_trigger_data` ENABLE KEYS */;
UNLOCK TABLES;
