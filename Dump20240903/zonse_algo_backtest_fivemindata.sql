...
--
-- Table structure for table `backtest_fivemindata`
--

DROP TABLE IF EXISTS `backtest_fivemindata`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `backtest_fivemindata` (
...
--
-- Dumping data for table `backtest_fivemindata`
--

LOCK TABLES `backtest_fivemindata` WRITE;
/*!40000 ALTER TABLE `backtest_fivemindata` DISABLE KEYS */;
/*!40000 ALTER TABLE `backtest_fivemindata` ENABLE KEYS */;
UNLOCK TABLES;
