...
--
-- Table structure for table `backtest_threemindatacompare`
--

DROP TABLE IF EXISTS `backtest_threemindatacompare`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `backtest_threemindatacompare` (
...
--
-- Dumping data for table `backtest_threemindatacompare`
--

LOCK TABLES `backtest_threemindatacompare` WRITE;
/*!40000 ALTER TABLE `backtest_threemindatacompare` DISABLE KEYS */;
/*!40000 ALTER TABLE `backtest_threemindatacompare` ENABLE KEYS */;
UNLOCK TABLES;
